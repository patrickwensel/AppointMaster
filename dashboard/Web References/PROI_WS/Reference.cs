...
namespace dashboard.PROI_WS {
    ...
    public partial class ROIServices : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ROIServices() {
            this.Url = global::dashboard.Properties.Settings.Default.dashboard_PROI_WS_ROIServices;
        ...
        public string testRoiReplyPerPractice(string password, int db, string phone0, string phone1, string email, string patientName, string patientFirstName) {
        ...
        /// <remarks/>
        public void testRoiReplyPerPracticeAsync(string password, int db, string phone0, string phone1, string email, string patientName, string patientFirstName) {
            this.testRoiReplyPerPracticeAsync(password, db, phone0, phone1, email, patientName, patientFirstName, null);
        }
        
        /// <remarks/>
        public void testRoiReplyPerPracticeAsync(string password, int db, string phone0, string phone1, string email, string patientName, string patientFirstName, object userState) {
            ...
            this.InvokeAsync("testRoiReplyPerPractice", new object[] {
                        ...
                        email,
                        patientName,
                        patientFirstName}, this.testRoiReplyPerPracticeOperationCompleted, userState);
        }
