...
<div class=""popupscroll""><div style=""text-align:center"">
            ...
            <div class=""small-dark-box"">
				<div class=""small-top"">REF TOTAL</div>
				<div class=""small-bottom"">#REFTOTAL</div>
			</div>
		...
		<table class=""practiceroi-table practiceroi-plan-table"">
            ...
            <tr class='referralRow'>
				<td colspan=""4"" class=""nopadding right""><div class=""separator"">Subtotal referral treatment plan: @SUBTOTALREF_TP</div></td>
			</tr>
            @BLOCKLINE_REFPROD
			<tr class='referralRow'>
...
";
                ...
                while (DbReader.Read())
                {
                    ...
                    amount = DbReader.GetDecimal(5);
                    isTp = DbReader.GetInt16(7) == 1;
                    string name = string.Format("{0} {1}", DbReader.GetString(8), DbReader.GetString(9));
                    ...
                    if (lastTp >= 0)
                    {
                        ...
                        if (newiTp != lastTp)
                        {
                            if (lastTp == 1)
                            {
                                newS = newS.Replace("@BLOCKLINEREF_TP", s);
                                newS = newS.Replace("@SUBTOTALREF_TP", SubTotal.ToString("C0"));
                                s = "";
                            }
                            else
                            {
                                newS = newS.Replace("@BLOCKLINE_REFPROD", s);
                                newS = newS.Replace("@SUBTOTALREF_PROD", SubTotal.ToString("C0"));
                                s = "";
                            }
                            SubTotal = 0;
                        }
                ...
                newS = newS.Replace("@BLOCKLINEREF_TP", "");
                newS = newS.Replace("@SUBTOTALREF_TP", "");
                newS = newS.Replace("@BLOCKLINE_REFPROD", "");
                newS = newS.Replace("@SUBTOTALREF_PROD", "");

                newS = newS.Replace("#REFTOTAL", totalAmount.ToString("C0"));
...
<img src=""images/stop.png"" id=""pause_01"" onclick=""pause();"" style=""display:none""  title=""Pause""/>";
        ...
        class tableLine
        {
            ...
            public decimal referredProduction;
            public int DB;
            public int campId;
            public int LeadId;
            ...
            public void CopyInto(ref tableLine instance)
            {
                ...
                if (this.referredProduction > 0)
                    instance.referredProduction = this.referredProduction;
        ...
        private tableLine getLineFromReader(SqlDataReader DbReader, int DB, int campId)
        {
            try
            {
                ...
                if (!DbReader.IsDBNull(11))
                    line.referredProduction = DbReader.GetDecimal(11);
...
<table class=""practiceroi-table"">
			<tr class=""practiceroi-table-header"">
				...
				<td class=""col9 right"">Production</td>
	            <td class=""col10 center"">Referred Production</td>
			</tr>
		</table>
</div>
...
";
                ...
                if (tmpS != "")
                    s += "<tr><td colspan=\"10\" class=\"nopadding\"><div class=\"separator\">Matches found without treatments posted yet</div></td></tr>";
                s += tmpS;
                ...
                if (tmpS != "")
                    s += "<tr><td colspan=\"10\" class=\"nopadding\"><div class=\"separator\">Unconverted Opportunities</div></td></tr>";
                s += tmpS;
